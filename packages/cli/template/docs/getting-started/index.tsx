import type { DesignSystem, DocMeta, Page } from '@open-pdf/core';
...
// ─── Shared animations (injected per doc so direct-nav also works) ──────────
const styles = `
  @keyframes es-fadeUp {
  ...
  <div style={fill}>
    ...
    >
      ...
      <div>
        ...
        >
          Three steps from empty folder to a live, editable doc.
        </p>
      </div>
...
const Init: Page = () => {
  const stream: InitLine[] = [
    ...
    {
      kind: 'success',
      text: 'Created open-pdf workspace',
      dim: 'in /Users/you/my-doc',
    },
    { kind: 'blank' },
    ...
    { kind: 'cmd', text: 'cd my-doc' },
    { kind: 'cmd', text: 'pnpm dev' },
    { kind: 'blank' },
    {
      kind: 'dim',
      text: 'Then open the dev server and start authoring in docs/<your-doc>/.',
    },
  ];
...
// ─── Doc 3: Prompt → create-doc → pages appear ───────────────────────────
const Prompt: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        >
          {/* LEFT — agent CLI */}
          <WindowShell title="claude · ~/my-doc">
            <div
              style={{
                flex: 1,
                padding: '28px 36px',
            ...
            >
              ...
              <AgentLine speaker="tool" delay={2.7}>
                <div style={{ color: palette.muted }}>
                  write <span style={{ color: palette.text }}>docs/q2-launch/index.tsx</span>
                </div>
              </AgentLine>
...
// ─── Doc: Visual editor (click → tweak → save) ─────────────────────────────
    ...
    <div style={fill}>
      ...
      >
        ...
        <WindowShell title="localhost:5173/s/q2-launch · assets" style={{ flex: 1, minHeight: 0 }}>
          ...
          >
            {/* Toolbar: Docs/Assets switcher + Upload */}
            <div
              style={{
                padding: '20px 28px',
                borderBottom: `1px solid ${palette.border}`,
    ...
    >
      <div className="es-fadeUp">
        ...
        >
          ...
          <span style={{ fontFamily: font.mono, color: palette.accentSoft }}>@pdf-comment</span>{' '}
          ...
          >
            ...
            >
              ...
              >
                ...
                {'{/* '}
                <span style={{ color: palette.accentSoft }}>@pdf-comment</span> id=
            ...
            <AgentLine speaker="tool" delay={3.8}>
              <div style={{ color: palette.muted }}>
                edit <span style={{ color: palette.text }}>docs/q2-launch/index.tsx</span>{' '}
      ...
      >
        ...
        <div className="es-fadeUp" style={{ animationDelay: '0.15s' }}>
          ...
          >
            ...
            <code style={{ fontFamily: font.mono, color: palette.accentSoft }}>/create-doc</code>{' '}
        ...
        >
          <span>
            extract from a doc, image, or prose —{' '}
...
const Recap: Page = () => {
  const steps = [
    { n: '01', title: 'init', caption: 'npx @open-pdf/cli init' },
    { n: '02', title: 'prompt', caption: 'create-doc' },
  ...
  return (
    <div style={fill}>
      ...
      >
        ...
        >
          <span>
            edit <span style={{ color: palette.text }}>docs/&lt;your-doc&gt;/index.tsx</span> — HMR
            does the rest
          </span>
          <span>open-pdf</span>
        </div>
...
const AgentAgnostic: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          <Eyebrow>why open-pdf · 01</Eyebrow>
          <h2
            style={{
              marginTop: 24,
              marginBottom: 0,
          ...
          >
            open-pdf speaks plain React and a file-convention protocol. Any agent can author and
            edit docs — no lock-in, no bespoke SDK.
          </p>
        </div>
...
const FreeLayout: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          <Eyebrow>why open-pdf · 02</Eyebrow>
          <h2
            style={{
              marginTop: 24,
              marginBottom: 0,
          ...
          >
            Zero layouts. Zero doc types. Zero "themes". Each page is just a React component on a
...
const GitTracked: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          <Eyebrow>why open-pdf · 03</Eyebrow>
          <h2
            style={{
              marginTop: 20,
              marginBottom: 0,
          ...
          >
            Every doc is a file in your repo. No proprietary database. No SaaS lock-in. No
        ...
        >
          <WindowShell title="~/my-doc — git log">
            <div
              style={{
                flex: 1,
                background: palette.surface,
            ...
            >
              <div style={{ color: palette.muted, marginBottom: 14 }}>
                <span style={{ color: palette.mint }}>$</span> git log --oneline docs/q2-launch/
              </div>
              {commits.map((c, i) => (
                <div
                  key={c.hash}
...
const DeployAnywhere: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        <div className="es-fadeUp">
          <Eyebrow>why open-pdf · 04</Eyebrow>
          <h2
            style={{
              marginTop: 24,
              marginBottom: 0,
          ...
          >
            open-pdf builds to plain static assets. Drop them on Vercel, Cloudflare, Zeabur — or any
...
export const meta: DocMeta = {
  title: 'Getting started with open-pdf',
};
