...
export const ja: Locale = {
  ...
  common: {
    ...
    loading: '読み込み中',
    loadFailed: '読み込みに失敗',
    failedToLoadDoc: 'スライドの読み込みに失敗しました',
    home: 'ホーム',
    backToHome: 'ホームへ戻る',
    preview: 'プレビュー',
    add: '追加',
  ...
  home: {
    ...
    toastDocDuplicated: '「{doc}」を {newDoc} として複製しました',
    toastDocDuplicateFailed: 'スライドを複製できませんでした',
    toastDocMoved: '「{doc}」を {folder} に移動しました',
  ...
  asset: {
    ...
    deleteAssetInUseDescription: '{name} は {docs} 枚のスライドで {count} 箇所使用されています。',
    deleteAssetInUseHint: '削除すると、これらの使用箇所は画像プレースホルダーに戻ります。',
    deleteAndRevert: '削除して戻す',
    toastRevertFailed: '{docId} の使用箇所を戻せませんでした',
  ...
  commandMenu: {
    ...
    docPlaceholder: 'このデッキを検索、またはコマンドを実行…',
    empty: '結果がありません。',
    groupDocs: 'スライド',
    groupFolders: 'フォルダ',
    groupNavigation: '移動',
