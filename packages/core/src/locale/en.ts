...
export const en: Locale = {
  ...
  common: {
    ...
    failedToLoadDoc: 'Failed to load doc',
    home: 'Home',
  ...
  home: {
    ...
    folderEmptyHint: 'Drag a doc from Draft into this folder in the sidebar.',
    docActions: 'Doc actions',
    moveToFolder: 'Move to folder…',
    renameDialogEyebrow: 'Rename',
    renameDialogTitle: 'Rename doc',
    renameDialogDescription: 'Give this doc a new display name.',
    docNamePlaceholder: 'Doc name',
    moveDialogEyebrow: 'Move',
    moveDialogTitle: 'Move doc',
    moveDialogDescriptionPrefix: 'Choose a folder for ',
    moveDialogDescriptionSuffix: '.',
    deleteDialogEyebrow: 'Destructive',
    deleteDialogTitle: 'Delete doc?',
    ...
    toastDocDuplicated: 'Duplicated “{doc}” as {newDoc}',
    toastDocDuplicateFailed: 'Could not duplicate doc',
    toastDocMoved: 'Moved “{doc}” to {folder}',
    toastDocMoveFailed: 'Failed to move doc',
  ...
  doc: {
    ...
    agentConnectedTooltip:
      'The current doc and inspector selection are synced to your agent in real time.',
    agentDisconnected: 'Agent disconnected',
    agentDisconnectedTooltip:
      'Lost connection to the dev server, so your agent can no longer see the current doc or inspector selection. Restart the dev server to restore the connection.',
    download: 'Download',
    copyLink: 'Copy link',
  ...
  presenter: {
    ...
    noNotesPrefix: 'No speaker notes for this doc. Add ',
    noNotesSuffix: ' to your doc module to see notes here.',
  ...
  present: {
    prevDocAria: 'Previous doc (←)',
    nextDocAria: 'Next doc (→)',
    overviewAria: 'Doc overview (O)',
    ...
    shortcutNext: 'Next doc',
    shortcutPrev: 'Previous doc',
    shortcutFirstLast: 'First / last doc',
    shortcutJump: 'Jump to doc',
    shortcutOverview: 'Doc overview',
    ...
    overviewDialogAria: 'Doc overview',
    overviewEyebrow: 'Overview',
    overviewGoToAria: 'Go to doc {n}',
    nowBadge: 'Now',
  },
  ...
  inspector: {
    ...
    pickerEmpty: "No images in this doc's assets folder yet. Add some from the Assets tab.",
    ...
    commentsEmpty: 'No comments yet. Toggle Inspect and click a doc element.',
  ...
  asset: {
    ...
    deleteAssetDescription: 'Delete {name}? Imports referencing this file in the doc will break.',
    deleteAssetInUseDescription: '{name} is used in {count} place(s) across {docs} doc(s).',
    deleteAssetInUseHint: 'Deleting will revert these usages back to image placeholders.',
    deleteAndRevert: 'Delete & revert',
    toastRevertFailed: "Couldn't revert usage in {docId}",
  ...
  thumbnailRail: {
    ...
    transitionIndicator: 'Has doc transition',
  ...
  commandMenu: {
    ...
    docPlaceholder: 'Search this deck or run a command…',
    empty: 'No results.',
    groupDocs: 'Docs',
  ...
  notesDrawer: {
    ...
    placeholder: 'Write speaker notes for this doc…',
    statusSaving: 'Saving…',
    statusSaved: 'Saved',
  ...
  themes: {
    ...
    noThemesHintSuffix: ' to author one — a markdown file under themes/ plus a sibling demo doc.',
    noDemoYet: 'No demo yet',
    noDemoHintPrefix: 'Re-run ',
    noDemoHintSuffix: ' for this theme to generate a preview doc.',
    backToGallery: 'Back to themes',
    pageOf: 'page {n}/{total}',
    nextPageAria: 'Next page',
    prevPageAria: 'Previous page',
    openThemeAria: 'Open theme {name}',
    usedBy: 'Docs using this theme',
    usedByEmpty: 'No docs use this theme yet.',
