...
export const zhCN: Locale = {
  ...
  home: {
    ...
    toastDocDuplicated: '已将"{doc}"复制为 {newDoc}',
    toastDocDuplicateFailed: '无法复制幻灯片',
    toastDocMoved: '已将"{doc}"移至 {folder}',
  ...
  doc: {
    ...
    agentConnectedTooltip: '目前的 doc 与 Inspector 选择会即时同步给 agent。',
    agentDisconnected: 'Agent 已断开',
    agentDisconnectedTooltip:
      '已和 dev server 断开连接，agent 没办法再看到你目前的 doc 或 Inspector 选择。请重新启动 dev server 来恢复连接。',
    home: '首页',
    backToHome: '返回首页',
    download: '下载',
    copyLink: '复制链接',
  ...
  asset: {
    ...
    deleteAssetInUseDescription: '{name} 在 {docs} 个幻灯片中被使用了 {count} 次。',
    deleteAssetInUseHint: '删除后这些使用处会自动还原为图片占位符。',
    deleteAndRevert: '删除并还原',
    toastRevertFailed: '无法还原 {docId} 中的使用',
  ...
  themes: {
    ...
    noThemesHintSuffix: ' 来创建一个 — 一个位于 themes/ 的 markdown 文件，加上同名的 demo doc。',
    noDemoYet: '尚无 demo',
    noDemoHintPrefix: '对此主题重新运行 ',
    noDemoHintSuffix: ' 即可生成预览用的 doc。',
