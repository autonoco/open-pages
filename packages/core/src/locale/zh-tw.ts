...
export const zhTW: Locale = {
  ...
  home: {
    ...
    toastDocDuplicated: '已將「{doc}」複製為 {newDoc}',
    toastDocDuplicateFailed: '無法複製投影片',
    toastDocMoved: '已將「{doc}」移至 {folder}',
  ...
  doc: {
    ...
    agentConnectedTooltip: '目前的 doc 與 Inspector 選擇會即時同步給 agent。',
    agentDisconnected: 'Agent 已斷線',
    agentDisconnectedTooltip:
      '已和 dev server 斷線，agent 沒辦法再看到你目前的 doc 或 Inspector 選擇。請重新啟動 dev server 來恢復連線。',
    home: '首頁',
    backToHome: '返回首頁',
    download: '下載',
    copyLink: '複製連結',
  ...
  asset: {
    ...
    deleteAssetInUseDescription: '{name} 在 {docs} 個投影片中被使用了 {count} 次。',
    deleteAssetInUseHint: '刪除後這些使用處會自動還原為圖片占位符。',
    deleteAndRevert: '刪除並還原',
    toastRevertFailed: '無法還原 {docId} 中的使用',
  ...
  themes: {
    ...
    noThemesHintSuffix: ' 來建立一個 — 一個位於 themes/ 的 markdown 檔案，加上同名的 demo doc。',
    noDemoYet: '尚無 demo',
    noDemoHintPrefix: '對此主題重新執行 ',
    noDemoHintSuffix: ' 即可產生預覽用的 doc。',
