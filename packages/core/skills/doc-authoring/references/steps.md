...
If `docs/build-on-reveal/` exists in this project (the demo workspace ships it), study it before authoring a stepped page; otherwise the rules and snippets below are sufficient.

```tsx
import { Step, Steps } from '@open-pdf/core';
