...
1. Scans the workspace for `@pdf-comment` markers.
...
```text
› /apply-comments
✓ 3 markers · docs/q2-launch/index.tsx
✓ 1 marker  · docs/intro/index.tsx
```

## Marker semantics

A `@pdf-comment` marker is a normal JSX/JS comment that the inspector
