---
title: Page
description: The component contract for one 1920 × 1080 doc page.
---

`Page` is the base primitive in open-pdf. A deck is just an ordered array of
...
import { type Page, type DocMeta, useDocPageNumber } from '@open-pdf/core';
...
const coverTransition: DocTransition = {
  duration: 240,
  enter: {
    keyframes: [
