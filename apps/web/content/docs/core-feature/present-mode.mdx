...
![Open-doc presenter view with the current doc, next-doc preview, speaker notes, and timer](/assets/screenshots/presenter.webp)
...
- **Current doc** at the size you'll show it.
- **Next doc** preview.
