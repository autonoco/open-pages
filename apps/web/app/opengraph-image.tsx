...
const SERIF_400 = '“make the headline bigger”applied by your agent · re-rendered in 24msOP-0001 · PDF 1.7';
...
export default async function OgImage() {
  ...
  return new ImageResponse(
    ...
    >
      {/* Brand lockup */}
      <div style={{ position: 'absolute', left: 64, top: 60, display: 'flex', alignItems: 'center', gap: 14 }}>
        <svg width="40" height="40" viewBox="0 0 32 32" fill="none" role="img" aria-label="open-pdf mark">
          <path
          ...
          />
          <path d="M19 3v6.5h6.5L19 3Z" fill="#E05A3A" stroke="#E05A3A" strokeWidth="1.5" strokeLinejoin="round" />
          <path d="M11.5 16h9M11.5 20.5h9M11.5 25h5.5" stroke="#F5F1E8" strokeWidth="2" strokeLinecap="round" />
        </svg>
        <div style={{ fontFamily: 'JetBrains Mono', fontSize: 24, color: '#a8a49b' }}>openpdf.sh</div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 44, fontSize: 15, fontWeight: 600, letterSpacing: 4, color: '#c63a21' }}>
          A FRAMEWORK
        </div>
        ...
        >
          <div style={{ fontSize: 54, fontWeight: 600, lineHeight: 1.12, color: '#1a1917' }}>{HEADLINE_1}</div>
          <div style={{ fontSize: 54, fontWeight: 600, lineHeight: 1.12, color: '#1a1917' }}>{HEADLINE_2}</div>
        </div>

        <div style={{ marginTop: 46, fontSize: 13, fontWeight: 600, letterSpacing: 3, color: '#6b675f' }}>
          SIGN HERE TO BEGIN
        </div>
        <div
          style={{
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ fontFamily: 'JetBrains Mono', fontSize: 14, color: '#57534a' }}>h1 · index.tsx:17</div>
        </div>
