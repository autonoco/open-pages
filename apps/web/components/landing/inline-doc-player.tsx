...
import demoDocs from './demo-doc';

const CANVAS_W = 1920;
const CANVAS_H = 1080;

export const inlineDocCount = demoDocs.length;
...
export function InlineDocPlayer({ index, onIndexChange }: Props) {
  const docs = demoDocs;
  ...
  return (
    <div
      ref={rootRef}
      onKeyDown={onKeyDown}
      aria-roledescription="doc player"
      aria-label={`Doc ${index + 1} of ${count}`}
