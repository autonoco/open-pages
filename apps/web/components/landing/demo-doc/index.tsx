...
type DocMeta = { title?: string; theme?: 'light' | 'dark' };

// Vite returns a URL string for asset imports; Next.js/Turbopack returns an
// object like { src, width, height }. Normalize to a string so the doc
...
const Init: Page = () => {
  const stream = [
    '',
    'Created open-pdf workspace in /Users/you/my-doc',
    '',
    'Next steps:',
    '  cd my-doc',
    ...
    '  pnpm dev',
    '',
    'Then open the dev server and start authoring in docs/<your-doc>/.',
  ];
  return (
    <div style={fill}>
      <Styles />
