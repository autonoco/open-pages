...
const Cover: Page = () => (
  ...
  >
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
      <div style={EYEBROW}>open-pdf · field notes · vol. ii</div>
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        Eight effects you can&rsquo;t draw in a binary doc format — every one in under twenty lines
...
const Glitch: Page = () => (
  <Show
    ...
    body="The cyan and magenta channels split by a few pixels in opposite directions; steps(5) drops the framerate on purpose. The whole effect is two filters stacked on a div — there is no doc format on earth that can serialize this as a binary blob."
    glyph={GlitchGlyph}
  />
);
  ...
  >
    ...
    <div style={{ alignSelf: 'center' }}>
      ...
      >
        ...
        npx <span style={{ color: 'var(--osd-accent)' }}>@open-pdf/cli</span> init
      </div>
      <p
        style={{
          fontSize: 26,
...
// fakes a dropped framerate. The kind of motion a binary doc format can't even describe.
Glitch.transition = {
  duration: 560,
  exit: {
    duration: 260,
