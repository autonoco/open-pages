import type { DesignSystem, DocMeta, DocTransition, Page } from '@open-pdf/core';
import createDocSkill from './assets/create-doc-skill.webp';
import initCommand from './assets/init-command.webp';
import opendocHome from './assets/opendoc-home.webp';
  ...
  <div style={fillLight}>
    ...
    >
      ...
      <div>
        ...
        >
          A hands-on guide to running open-pdf in the Replit Agent — install it, preview the
      ...
      >
        ...
        >
          <Step n="01" title="Ask the Agent to init">
            ...
            >
              <span style={{ color: p.accent }}>$</span> npx @open-pdf/cli init
            </code>
          </Step>
          <Step n="02" title="Open &amp; explore">
            open-pdf boots in the webview. Click any example doc to view it in the deck.
          </Step>
        </div>
        ...
        >
          <div>
            <Shot
              src={initCommand}
              ratio={1534 / 238}
              alt="Typing the open-pdf init command into the Replit Agent prompt"
            />
          ...
          <div>
            <Shot
              src={opendocHome}
              ratio={3818 / 1780}
              alt="open-pdf home page running inside Replit with an example doc"
            />
            <Caption>open-pdf running in your Repl — examples ready to open.</Caption>
          </div>
        </div>
      </div>
    </div>
    ...
    >
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.18s' }}>
          ...
          <PromptCard>
            use the <span style={{ fontFamily: font.mono, color: p.accent }}>/create-doc</span>{' '}
            skill to make docs introducing Replit's features, and apply the Replit brand theme.
          </PromptCard>
        </div>
        ...
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            src={createDocSkill}
            ratio={3817 / 1781}
            alt="The create-doc skill interviewing the user about the deck's visual direction"
          />
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            ...
            ratio={3815 / 1783}
            alt="A finished Replit features doc deck rendered in open-pdf inside Replit"
          />
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.18s' }}>
          <p style={{ margin: 0, fontSize: 32, color: p.mutedLight, lineHeight: 1.5 }}>
            ...
            to a live URL. Share the link, and anyone can open the docs in their browser.
          </p>
          <div
            style={{
              marginTop: 28,
          ...
          >
            ...
            >
              open-pdf-init--ridemountainpig.replit.app
            </span>
          </div>
        </div>
        ...
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            src={replitDeploy}
            ratio={2950 / 1158}
            alt="Replit Publishing panel showing the open-pdf deck deploying to a live replit.app URL"
          />
  ...
  >
    ...
    >
      ...
      <div>
        ...
        >
          Spin up a Repl, run <code style={{ fontFamily: font.mono }}>npx @open-pdf/cli init</code>,
          and let the Agent design your docs.
        </p>
      </div>
...
export const meta: DocMeta = {
  title: 'Using open-pdf in Replit',
  theme: 'replit',
