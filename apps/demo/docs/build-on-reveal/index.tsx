import { type DesignSystem, type DocMeta, type Page, Step, Steps } from '@open-pdf/core';
...
const Cover: Page = () => (
  ...
  >
    <div style={EYEBROW}>open-pdf · primitives</div>
      ...
      <Steps>
        ...
        <Step>
          <p style={{ fontSize: 34, lineHeight: 1.5, margin: 0 }}>
            Finally, the turn — the line that re-frames everything above and makes the doc a single
            idea, revealed.
          </p>
        </Step>
      </Steps>
...
const Closing: Page = () => (
  ...
  >
    ...
    <div style={{ alignSelf: 'center', maxWidth: 1400 }}>
      ...
      >
        Jumping into this doc via the overview grid shows it fully composed. Stepping in linearly
