...
import openPdf from './assets/open-pdf.png';
...
const Cover: Page = () => (
  ...
  >
    ...
    >
      ...
      >
        <Letters text="open-pdf" delay={780} step={42} duration={720} />
      </div>
    </div>
    ...
    >
      <div style={{ overflow: 'hidden' }}>
        <Letters text="A doc framework " delay={1500} step={26} />
      </div>
...
const Skill: Page = () => (
  ...
  >
    ...
    >
      <Letters text="/create-doc" delay={520} step={48} duration={780} anim="mSlamUp" />
      <span
        style={{
          display: 'inline-block',
          width: 26,
...
const Cli: Page = () => (
  ...
  >
    ...
    >
      ...
      <Letters text="npx @open-pdf/cli init" delay={780} step={42} duration={620} anim="mSlamUp" />
      <span
        style={{
          display: 'inline-block',
          width: 22,
    ...
    >
      Build docs with your <span style={{ color: tokens.accent, fontStyle: 'italic' }}>agent</span>.
    </div>
