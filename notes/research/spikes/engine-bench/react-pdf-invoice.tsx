      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.terms} wrap={false}>
          ...
          <Text style={styles.termsText}>
            ...
            per month. Please reference the invoice number on all remittances. Wire details
            available on request. All services are provided under the Master Services Agreement
