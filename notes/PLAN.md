...
- All spikes: copied into this repo at `notes/research/spikes/{engine-bench,takumi-spike,pdfcn-drift,pdfium-check,rpdf-spike}` (code, output PDFs, rasterizer PNGs, bench results; node_modules stripped — reinstall per-dir to re-run).
