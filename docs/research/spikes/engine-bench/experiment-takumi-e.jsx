...
await writeFile("exp-e-flexwrap.pdf", await render(<main tw="flex flex-col"><div tw="mb-6 flex flex-col"><span tw="text-[21px] font-bold">Header block</span><span>Some intro content above the table</span></div>{table}</main>, {
