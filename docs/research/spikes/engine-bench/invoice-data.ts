...
const BASE_ITEMS: LineItem[] = [
  {
    sku: 'SKU-1001',
    description: 'Cloud compute credits',
    detail: 'Reserved c7g.xlarge, us-east-1, 730 hrs',
    qty: 4,
    unitPrice: 118.4,
  },
  {
    ...
    detail: 'Standard tier, 12 TB-month',
    qty: 12,
    unitPrice: 23.55,
  },
  {
    ...
    detail: 'db.r6g.large, multi-AZ, 730 hrs',
    qty: 2,
    unitPrice: 342.0,
  },
  {
    ...
    detail: 'North America + EU, 8.2 TB',
    qty: 8,
    unitPrice: 71.25,
  },
  {
    ...
    detail: 'Structured logs, 950 GB indexed',
    qty: 1,
    unitPrice: 1140.0,
  },
  {
  ...
  },
  {
    ...
    detail: 'Transactional, 480k sends',
    qty: 48,
    unitPrice: 9.8,
  },
  {
    ...
    detail: '24 hosted zones + 41M queries',
    qty: 24,
    unitPrice: 3.5,
  },
  {
    ...
    detail: '1,180 secrets, API ops included',
    qty: 118,
    unitPrice: 0.4,
  },
  {
    ...
    detail: 'Private repos, 640 GB stored',
    qty: 64,
    unitPrice: 2.1,
  },
  {
    sku: 'SKU-1012',
    description: 'SSO seats',
    detail: 'SAML/OIDC, 85 seats',
    qty: 85,
    unitPrice: 6.0,
  },
];
