...
const doc = h(
  "main",
  { "data-loc": "src/Invoice.tsx:5:3", style: { display: "flex", flexDirection: "column", gap: 16 } },
  h("h1", { "data-loc": "src/Invoice.tsx:6:5", "data-custom": 42, tw: "text-2xl" }, "Invoice INV-001"),
  h(
    "section",
